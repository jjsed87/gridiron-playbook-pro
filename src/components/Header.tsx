...
const Header: React.FC<HeaderProps> = ({ title = "Gridiron Playbook Pro" }) => {
  return (
    <header className="bg-purple-dark text-white p-4 sticky top-0 z-50 shadow-md">
        ...
        <div className="md:hidden">
          <Sheet>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="text-white hover:bg-purple-light/20">
                <Menu className="h-6 w-6" />
              </Button>
            </SheetTrigger>
            <SheetContent side="right" className="bg-purple-light p-0">
